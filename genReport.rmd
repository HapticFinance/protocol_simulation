...
TDA price is `r prettyNum(pool_state[4], scientific=F, big.mark=",")` USD  
Total sold is **`r prettyNum(pool_state[6], scientific=F, big.mark=",")`** TDA - total sales `r pool_state[5]`  
Total purchased is **`r prettyNum(pool_state[8], scientific=F, big.mark=",")`** TDA  - total purchases `r pool_state[7]`  
